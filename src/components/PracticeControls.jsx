...
const BUTTON_CLASS =
  ...
  'duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-violet'
...
function PracticeControls({ controls, onEvent }) {
  ...
  return (
    <div className="min-h-[4rem] mt-6 flex gap-4 justify-center items-center">
      {hasControls &&
